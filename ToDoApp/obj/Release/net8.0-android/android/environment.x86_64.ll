...
@dso_cache = dso_local local_unnamed_addr global [526 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 524583555740010712, ; hash 0x747b1f6eee508d8, from name: aot-ToDoApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ToDoApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 16
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 6843638944652621169, ; hash 0x5ef97d5c6b0c7571, from name: aot-ToDoApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ToDoApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 175
	...
	%struct.DSOCacheEntry {
		i64 9080704161357076279, ; hash 0x7e052452b8199737, from name: libaot-ToDoApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ToDoApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 259
	...
	%struct.DSOCacheEntry {
		i64 11890609579978850941, ; hash 0xa503ee69f17f027d, from name: libaot-ToDoApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ToDoApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 340
	...
	%struct.DSOCacheEntry {
		i64 16844306230174329400, ; hash 0xe9c2ff457970aa38, from name: ToDoApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ToDoApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 483
	...
	%struct.DSOCacheEntry {
		i64 17717303805566574013, ; hash 0xf5e081f0dc78ddbd, from name: ToDoApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ToDoApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 500
...
@.env.3 = private unnamed_addr constant [37 x i8] c"7baea377-e262-4f6b-abe8-ed2cd388888e\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [22 x i8] c"libaot-ToDoApp.dll.so\00", align 16
