...
@dso_cache = dso_local local_unnamed_addr global [526 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 796421385, ; hash 0x2f786d09, from name: libaot-ToDoApp.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 2505960126, ; hash 0x955deabe, from name: ToDoApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ToDoApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 297
	...
	%struct.DSOCacheEntry {
		i64 2914800433, ; hash 0xadbc5331, from name: ToDoApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ToDoApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 353
	...
	%struct.DSOCacheEntry {
		i64 3007040254, ; hash 0xb33bcafe, from name: libaot-ToDoApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ToDoApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 367
	...
	%struct.DSOCacheEntry {
		i64 3745466337, ; hash 0xdf3f47e1, from name: aot-ToDoApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ToDoApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 458
	...
	%struct.DSOCacheEntry {
		i64 3859061340, ; hash 0xe6049a5c, from name: aot-ToDoApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-ToDoApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 472
